...
import { Estudio } from "@/compartilhado/tipos_globais/modelos";
...
const ContextoEstudio = createContext<ContextoEstudioProps>({} as ContextoEstudioProps);
...
export function ProvedorEstudio({ children }: { children: ReactNode }) {
    ...
    return (
        <ContextoEstudio.Provider value={valor}>
            {!carregando && children}
        </ContextoEstudio.Provider>
    );
}
