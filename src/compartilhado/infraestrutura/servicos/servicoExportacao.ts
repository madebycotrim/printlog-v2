...
export const servicoExportacao = {
    ...
    gerarRelatorioPortabilidade: (titular: any, pedidos: any[]) => {
        ...
        const relatorio = {
            ...
            avisoPrivacidade: "Este documento contém dados pessoais protegidos pela Lei 13.709/2018. O tratamento destes dados após o download é de responsabilidade exclusiva do titular."
        };

        servicoExportacao.exportarJSON(relatorio, `portabilidade_printlog_${titular.nome.toLowerCase().replace(/\s/g, '_')}`);
    },
