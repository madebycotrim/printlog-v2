...
import { StatusVidaUtil, obterStatusManutencao } from "@/funcionalidades/producao/impressoras/utilitarios/utilitariosManutencao";
...
export const servicoPredicaoManutencao = {
    ...
    gerarAgendaPreditiva: (impressoras: Impressora[]): ItemAgendaManutencao[] => {
        ...
        impressoras.filter(imp => !imp.dataAposentadoria).forEach(imp => {
