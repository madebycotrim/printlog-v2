...
export function CartaoIdentidade() {
  ...
  return (
    <div className="col-span-1 lg:col-span-2 bg-white dark:bg-[#0e0e11] border border-gray-200 dark:border-white/5 rounded-2xl p-6 relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-32 h-32 rounded-full p-1 bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-blue-500/20">
            <div className="w-full h-full rounded-full bg-white dark:bg-[#0e0e11] p-1">
              {usuario?.fotoUrl ? (
                <img
                  src={usuario.fotoUrl}
                  alt="Avatar"
        ...
        <div className="flex-1 w-full space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              InformaÃ§Ãµes utilizadas em relatÃ³rios e orÃ§amentos.
            </p>
          </div>
