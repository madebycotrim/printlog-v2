...
export function CartaoDados() {
    ...
    return (
        <div className="col-span-1 lg:col-span-1 bg-white dark:bg-[#09090b] border border-gray-200 dark:border-white/5 rounded-2xl p-6 flex flex-col">
            <div className="flex items-start justify-between mb-6">
                <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white">Meus Dados</h3>
