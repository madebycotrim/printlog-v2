...
export function CartaoZonaPerigo() {
  return (
    <div className="col-span-1 lg:col-span-1 bg-white dark:bg-[#0e0e11] border border-gray-200 dark:border-white/5 rounded-2xl p-6 border-l-4 border-l-red-600 relative overflow-hidden">
      {/* Red Glow */}
      ...
      <div className="space-y-6">
        <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
          A exclusÃ£o da conta removerÃ¡ permanentemente todos os seus dados,
          configuraÃ§Ãµes e histÃ³ricos de impressÃ£o.{" "}
