...
export function CartaoSeguranca() {
  ...
  const isGoogle = usuario?.uid && !usuario.email; // SimplificaÃ§Ã£o, na real checarÃ­amos o providerData

  return (
    <div className="col-span-1 lg:col-span-1 bg-white dark:bg-[#0e0e11] border border-gray-200 dark:border-white/5 rounded-2xl p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400">NÃ£o configurada</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
          ...
          <span
            className={`text-[10px] font-bold ${isGoogle ? "text-blue-500 bg-blue-500/10" : "text-gray-500 bg-gray-500/10"} uppercase tracking-widest px-2 py-1 rounded-md`}
          >
