                ...
                <div className="space-y-12">
                    ...
                    <footer className="border-t border-white/5 pt-10 text-center">
                        <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-8">
                            <button onClick={() => navigate('/seguranca-e-privacidade')} className="text-sm font-medium text-sky-400 hover:text-sky-300 transition-colors flex items-center gap-2">
