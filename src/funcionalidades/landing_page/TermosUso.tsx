            ...
            <div className="relative z-10 container mx-auto px-6 py-20 max-w-4xl">
                ...
                <header className="mb-16 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-zinc-300 mb-6 backdrop-blur-md">
                        <span className="text-[10px] font-bold uppercase tracking-widest">Documento Legal</span>
                    </div>
                ...
                <div className="space-y-12">
                    ...
                    <article className="prose prose-invert prose-headings:font-bold prose-headings:text-white prose-p:text-zinc-400 prose-li:text-zinc-400 max-w-none">
                        ...
                        <section className="bg-zinc-900/30 border border-white/5 rounded-2xl p-8 backdrop-blur-sm hover:border-white/10 transition-colors mb-12">
                            ...
                            <p>
                                Ao acessar e utilizar o PrintLog ("Plataforma"), você concorda com estes Termos de Uso. Se você não concordar com qualquer parte destes termos, não deve utilizar nossos serviços.
                            </p>
                        </section>

                        {/* 2. Descrição */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">2. Descrição do Serviço</h3>
                        ...
                        {/* 3. Cadastro */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">3. Cadastro e Conta</h3>
                        ...
                        {/* 4. Uso Aceitável */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">4. Uso Aceitável</h3>
                        ...
                        {/* 5. Planos */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">5. Planos e Pagamentos</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">6. Propriedade Intelectual</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        {/* 7. Disponibilidade */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">7. Disponibilidade do Serviço</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        {/* 8. Limitação */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">8. Limitação de Responsabilidade</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        {/* 9. Encerramento */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">9. Encerramento</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        {/* 10. Alterações */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">10. Alterações nos Termos</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        {/* 11. Lei */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">11. Lei Aplicável</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        <section className="pl-4 border-l-2 border-white/5 hover:border-sky-500/50 transition-colors mb-12">
                            ...
                            <p className="text-sm leading-relaxed">
                                Para dúvidas sobre estes termos, entre em contato através do e-mail <a href="mailto:suporte@printlog.com.br" className="text-sky-400 hover:text-sky-300">suporte@printlog.com.br</a>.
                            </p>
                        </section>
                    ...
                    <footer className="border-t border-white/5 pt-10 text-center">
                        <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-8">
                            <button onClick={() => navigate('/seguranca-privacidade')} className="text-sm font-medium text-sky-400 hover:text-sky-300 transition-colors flex items-center gap-2">
