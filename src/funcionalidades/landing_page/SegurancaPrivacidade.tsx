    ...
    return (
        <div className="min-h-screen bg-[#050507] text-zinc-300 font-sans selection:bg-sky-500/30 selection:text-sky-200">
            ...
            <div className="fixed inset-0 pointer-events-none">
                ...
                <div className="absolute top-[10%] left-[20%] w-[500px] h-[500px] bg-sky-500/5 rounded-full blur-[120px] mix-blend-screen animate-pulse" style={{ animationDuration: '4s' }} />
                <div className="absolute bottom-[20%] right-[10%] w-[600px] h-[600px] bg-indigo-500/5 rounded-full blur-[120px] mix-blend-screen animate-pulse" style={{ animationDuration: '6s' }} />
            ...
            <div className="relative z-10 container mx-auto px-6 py-20 max-w-4xl">
                ...
                <header className="mb-20 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter mb-6">
                        No PrintLog, a proteção dos seus<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-indigo-500">dados é nossa prioridade.</span>
                    </h1>
                    <p className="text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed">
                        Conheça como mantemos suas informações seguras e resguardamos sua privacidade com tecnologias de ponta e políticas transparentes.
                    </p>
                </header>
                ...
                <div className="space-y-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 relative z-10">
                            <div className="space-y-3">
                                ...
                                <p className="text-zinc-400 text-sm leading-relaxed">
                                    Cada conta possui dados separados e inacessíveis por outros usuários. Utilizamos <strong className="text-sky-300">Row-Level Security (RLS)</strong> no banco de dados para garantir o isolamento completo.
                                </p>
                            </div>
                            <div className="space-y-3">
                    ...
                    <section>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                { title: 'Criptografia SSL/TLS', desc: 'Todas as conexões são protegidas com criptografia SSL de ponta a ponta, garantindo que seus dados não possam ser interceptados.', icon: 'lock' },
                                { title: 'Armazenamento seguro', desc: 'Utilizamos infraestrutura de nível empresarial com servidores seguros e políticas de acesso rigorosas.', icon: 'server' },
                                { title: 'Controle de acesso', desc: 'Sistema de autenticação robusto com verificação de e-mail e proteção contra senhas comprometidas.', icon: 'shield-check' }
                            ].map((item, i) => (
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <section className="space-y-6">
                            ...
                            <ul className="space-y-5">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-white font-bold text-sm">Sem compartilhamento com terceiros</h4>
                                        <p className="text-zinc-400 text-sm mt-1">Seus dados pessoais e informações de negócio nunca são compartilhados com empresas terceiras, parceiros ou anunciantes.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                                    <div className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0" />
                                    <div>
                                        ...
                                        <p className="text-zinc-400 text-sm mt-1">Podemos utilizar métricas globais anônimas e agregadas (como número total de usuários) apenas para melhoria do produto.</p>
                                    </div>
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="space-y-6">
                            <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/5 pb-4">Direitos (LGPD)</h2>
                            <div className="grid gap-4">
                                <div className="p-4 rounded-xl border border-dashed border-zinc-700 hover:border-zinc-500 transition-colors cursor-default">
                                    <h4 className="text-white font-bold text-sm mb-1 flex items-center gap-2">
                                        <Icon name="download" className="w-4 h-4 text-zinc-400" /> Exportar dados
                                    </h4>
                                    <p className="text-zinc-500 text-xs">Baixe todos os seus dados em formato CSV a qualquer momento.</p>
                                </div>
                                <div className="p-4 rounded-xl border border-dashed border-zinc-700 hover:border-red-500/50 hover:bg-red-500/5 transition-colors cursor-default group">
                                    <h4 className="text-white font-bold text-sm mb-1 flex items-center gap-2 group-hover:text-red-400">
                                        <Icon name="trash" className="w-4 h-4 text-zinc-400 group-hover:text-red-400" /> Excluir conta
                                    </h4>
                                    <p className="text-zinc-500 text-xs">Solicite a exclusão completa da sua conta e dados associados.</p>
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-900/20 to-purple-900/20 border border-indigo-500/20 p-8">
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                <span className="inline-block px-2.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide bg-indigo-500 text-white mb-2">Em breve</span>
                                <h3 className="text-xl font-bold text-white mb-2">Autenticação em Dois Fatores (2FA)</h3>
                                <p className="text-zinc-400 text-sm max-w-xl">
                                    Estamos desenvolvendo a autenticação em dois fatores para adicionar uma camada extra de segurança à sua conta. Você poderá utilizar aplicativos como Google Authenticator.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <footer className="border-t border-white/5 pt-10 mt-10 text-center">
                        ...
                        <p className="text-xs text-zinc-600">© 2026 PrintLog. Todos os direitos reservados.</p>
                    </footer>
...
function Icon({ name, className }: { name: string; className?: string }) {
    const icons: any = {
        ...
        'shield-check': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />,
        'download': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />,
        'trash': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />,
        'finger-print': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4" />
    };
