        ...
        <div className="min-h-screen bg-[#050507] text-zinc-300 font-sans selection:bg-sky-500/30 selection:text-sky-200">
            ...
            <div className="relative z-10 container mx-auto px-6 py-20 max-w-4xl">
                ...
                <nav className="flex items-center justify-between mb-16">
                    <button
                        onClick={() => navigate('/seguranca-privacidade')}
                ...
                <header className="mb-16 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 text-emerald-400 mb-6 backdrop-blur-md">
                        <span className="text-[10px] font-bold uppercase tracking-widest">LGPD & Proteção de Dados</span>
                    </div>
                ...
                <div className="space-y-12">
                    ...
                    <article className="prose prose-invert prose-headings:font-bold prose-headings:text-white prose-p:text-zinc-400 prose-li:text-zinc-400 max-w-none">
                        ...
                        <section className="bg-zinc-900/30 border border-white/5 rounded-2xl p-8 backdrop-blur-sm hover:border-white/10 transition-colors mb-12">
                            <h2 className="text-xl mb-4 flex items-center gap-3">
                                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-white/5 text-sm">1</span>
                                Introdução
                            </h2>
                            <p>
                                O PrintLog ("nós", "nosso" ou "Plataforma") está comprometido com a proteção da sua privacidade. Esta Política de Privacidade explica como coletamos, usamos, armazenamos e protegemos seus dados pessoais em conformidade com a Lei Geral de Proteção de Dados (LGPD - Lei nº 13.709/2018).
                            </p>
                        </section>

                        {/* 2. Dados Coletados */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">2. Dados Coletados</h3>
                            <p className="text-sm mb-2">Coletamos os seguintes tipos de dados:</p>
                            <ul className="list-disc pl-5 space-y-3 text-sm">
                                <li><strong>Dados de cadastro:</strong> nome, e-mail e senha criptografada.</li>
                                <li><strong>Dados de uso:</strong> informações sobre produtos, vendas, máquinas, filamentos e canais de venda que você cadastra na plataforma.</li>
                                <li><strong>Dados técnicos:</strong> logs de acesso, endereço IP e informações do dispositivo para fins de segurança.</li>
                            </ul>
                        </section>

                        {/* 3. Finalidade */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">3. Finalidade do Tratamento</h3>
                        ...
                        {/* 4. Compartilhamento */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">4. Compartilhamento de Dados</h3>
                        ...
                        {/* 5. Armazenamento */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">5. Armazenamento e Segurança</h3>
                        ...
                        {/* 6. Seus Direitos */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">6. Seus Direitos (LGPD)</h3>
                            <p className="text-sm mb-2">Conforme a LGPD, você tem direito a:</p>
                            <ul className="list-disc pl-5 space-y-3 text-sm">
                        ...
                        {/* 7. Retenção */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">7. Retenção de Dados</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        {/* 9. Alterações */}
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            <h3 className="text-lg text-white font-bold mb-2">9. Alterações nesta Política</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        <section className="pl-4 border-l-2 border-white/5 hover:border-emerald-500/50 transition-colors mb-12">
                            ...
                            <p className="text-sm leading-relaxed">
                                Para exercer seus direitos ou esclarecer dúvidas sobre esta política, entre em contato através do e-mail <a href="mailto:suporte@printlog.com.br" className="text-emerald-400 hover:text-emerald-300">suporte@printlog.com.br</a>.
                            </p>
                        </section>
                    ...
                    <footer className="border-t border-white/5 pt-10 text-center">
                        <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-8">
                            <button onClick={() => navigate('/seguranca-privacidade')} className="text-sm font-medium text-emerald-400 hover:text-emerald-300 transition-colors flex items-center gap-2">
