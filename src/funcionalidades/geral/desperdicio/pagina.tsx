        ...
        <div className="space-y-10 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <h3 className="text-4xl font-black tracking-tighter mb-4">{centavosParaReais(metricas.totalPerdidoCentavos)}</h3>
                ...
                >
                    ...
                    <h3 className="text-4xl font-black tracking-tighter mb-4 text-rose-500">{metricas.indiceDesperdicioPercentual}%</h3>
                ...
                >
                    ...
                    <h3 className="text-4xl font-black tracking-tighter mb-4 text-zinc-900 dark:text-white">{metricas.pesoTotalFalhasGramas}g</h3>
                    <p className="text-[10px] font-bold text-gray-400 uppercase leading-relaxed tracking-wider">
                ...
                <div className="p-10 rounded-[2.5rem] bg-white dark:bg-[#121214] border border-gray-100 dark:border-white/5 shadow-sm">
                    <div className="flex items-center justify-between mb-10">
                        <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-zinc-500">Evolução do Prejuízo</h4>
                        </div>
                    </div>
                ...
                <div className="p-10 rounded-[2.5rem] bg-white dark:bg-[#121214] border border-gray-100 dark:border-white/5 shadow-sm">
                    <div className="flex items-center justify-between mb-10">
                        <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-zinc-500">Fontes de Desperdício</h4>
                        </div>
                    </div>
            ...
            <div className="p-10 rounded-[2.5rem] bg-white dark:bg-[#121214] border border-gray-100 dark:border-white/5 shadow-sm">
                <div className="flex items-center justify-between mb-10">
                    <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-zinc-500 underline decoration-rose-500/30">Registros de Sucata Recomendados para Auditoria</h4>
                </div>

                <div className="space-y-4">
                    {metricas.topMotivosDesperdicio.map((item, index) => (
                        <div key={index} className="flex items-center justify-between p-6 rounded-2xl bg-gray-50 dark:bg-white/[0.02] border border-transparent hover:border-gray-200 dark:hover:border-white/10 transition-all group">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Material / Causa Identificada</p>
                                </div>
                            </div>
