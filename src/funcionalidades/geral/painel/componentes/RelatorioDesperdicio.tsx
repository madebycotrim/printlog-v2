import { Trash2, AlertTriangle, ArrowDownRight } from "lucide-react";
    ...
    return (
        <div className="p-10 rounded-[2.5rem] bg-white dark:bg-[#121214] border border-rose-500/10 dark:border-rose-500/5 shadow-sm relative overflow-hidden group">
            ...
            <div className="grid grid-cols-2 gap-4 mt-10">
                ...
                <button className="py-4 rounded-2xl border border-gray-100 dark:border-white/5 text-gray-400 font-black uppercase text-[10px] tracking-widest hover:bg-gray-50 dark:hover:bg-white/5 transition-all flex items-center justify-center gap-2">
                    Registrar Perda
                </button>
            </div>
        </div>
