            ...
            >
                    ...
                    <div className="relative" ref={menuRef}>
                        ...
                        <AnimatePresence>
                            {menuAberto && (
                                ...
                                >
                                    <button
                                        onClick={(e) => { e.stopPropagation(); aoEditar?.(pedido.id); setMenuAberto(false); }}
                                    ...
                                    <button
                                        onClick={(e) => { e.stopPropagation(); if (confirm("Deseja realmente excluir este pedido?")) excluirPedido(pedido.id); }}
                ...
                <div className="space-y-4 relative z-10">
                    <div className="flex items-center justify-between">
                        ...
                        {pedido.prazoEntrega && (
                            <div className={`flex items-center gap-1.5 px-2 py-1 rounded-lg border text-[9px] font-black uppercase tracking-widest ${estaAtrasado
