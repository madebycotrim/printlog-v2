...
interface PropriedadesModalExcluir {
  aberto: boolean;
  aoFechar: () => void;
  pedido: Pedido | null;
...
/**
 * Modal de Confirmação de Exclusão - Design Premium
 * Substitui o confirm() nativo do navegador para exclusão de pedidos.
 */
export function ModalExcluirPedido({ aberto, aoFechar, pedido, aoConfirmar }: PropriedadesModalExcluir) {
    ...
    >
      <div className="p-8 flex flex-col items-center text-center">
        ...
        <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-4 mb-8 w-full">
          ...
          <div className="mt-4 flex items-center justify-center gap-2 p-3 rounded-xl bg-rose-500/5 border border-rose-500/10 text-rose-500">
